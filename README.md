...
<a href="https://stackblitz.com/github/ydaydayup/myblog" rel="nofollow"><img src="https://developer.stackblitz.com/img/open_in_stackblitz.svg"></a>
</p>
...
如果你想要搭建一个类似的站点，可直接 [Fork](https://github.com/ydaydayup/myblog/fork) 本仓库使用，或者通过 [StackBlitz](https://stackblitz.com/github/ydaydayup/myblog) 在线运行本项目，或通过 [Vercel](https://vercel.com/new/clone?repository-url=https://github.com/ydaydayup/myblog/tree/main&project-name=blog&repo-name=blog) 一键部署。
...
```sh
git clone https://github.com/ydaydayup/myblog.git
cd blog
pnpm install
pnpm start
```
