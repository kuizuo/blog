...
![](assert/383f1b61d95268cdea3a30f142382a88_MD5.jpg)
...
![image-20221010134753749](assert/dd29980791c25713820611b0042b8dc6_MD5.png)

2、首次表单填写邮箱，学校，以及使用 Github 的目的。**表单所提交内容全都要使用英文**

![image-20221010134942952](assert/827a3d24a36ec7abf4b2ad8bde2858e3_MD5.png)
...
![image-20221010135500357](assert/cc4dddd75f0b907bc913353159eb624d_MD5.png)

其次第二个表单，根据你的学校信息填写即可。**切记到这一步的时候请不要使用科学上课，最好使用学校的网络来提交。**

![image-20221010135949606](assert/2d6675c7501f294ec7b2162d96aa7c4d_MD5.png)

4、点击 Process my application 提交，等待结果即可。

最终 Github 在今早发送邮箱告知我认证成功了！

![](assert/f40ea4d217b178fa754e1a0c6358b4c7_MD5.jpg)

只要你提供的学生信息真实有效，不断提交最终肯定是会成功的。在这认证期间我一共提交了 11 次请求。

![](assert/81fedc64f27c0a2d5ad2fb65b85edb83_MD5.png)

期间收到的 Gtihub Education 邮箱信息如下：

![](assert/061af1581ba62b87799d84ce98c4927d_MD5.jpg)
...
![](assert/51861e788b491d96aaad204651922f3b_MD5.png)

时隔一年，我的 github 学生认证到期了，然而就当我准备按照上述方式续期的时候。发现我的学校认证方式变得严格了起来，

![](assert/c0124af787cd98c3d0d18e18ce933842_MD5.png)
