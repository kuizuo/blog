...
这不是实习岗，我与企业签订的直接劳动合同（这下和学校的三方协议都可以不用签了），我是挺诧异的，毕竟此时我的身份还是应届生，按理来说我应该是签订实习合同后，转正再签劳动合同，这里只是蛮提一下。试用期 3 个月，薪资打 8 折。薪资在我当地还算 ok，但对于我而言并不理想。可能是曾经赚过比这还高上许多的薪资，从内心的角度多少是有一些不平衡。毕竟目前还是试用期，薪资这方面后续也能再谈。
