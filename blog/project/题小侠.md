...
![itopic](assert/22678fe38f7e752bedb6b671d6e7bcc1_MD5.jpg)

小程序的源码地址：[https://github.com/ydaydayup/question-man](https://github.com/ydaydayup/question-man)
...
![image-20220405213930313](assert/cb309b42631c6785e3d44ebfbde7a1ff_MD5.png)
...
![image-20220405214126617](assert/5baca6a8dfee712242d2e57d6befdb2d_MD5.png)
...
![img](assert/bc58242340401eefa221a06c2fda3c94_MD5.jpg)
...
![image-20220403125339679](assert/eb7ea4207f6cdd609064884b76a7144a_MD5.png)

在版本管理中的开发版本可以看到刚刚上传的代码

![image-20220403133323838](assert/4e1a414095ff979e14aa4c5648c29d8d_MD5.png)

点击提交审核后，会提示确保项目不是测试版与 Demo（否则将受到相应处罚）如下图

![image-20220403133707429](assert/0fe33ea1510a5d2169cc049cbbe18c05_MD5.png)
...
![image-20220406003544712](assert/7fcbb1fe5b8381bdb0f488a673fe70e1_MD5.png)

等待审核完毕，实测一天内，审核版本如下

![image-20220406123345533](assert/0fadcecfe11f54826548ac73920e3e47_MD5.png)

### 线上版本

最终提交发布，线上版本如下

![image-20220406125311142](assert/8eb02f288c86fdcb7430d60b3c692915_MD5.png)
...
![image-20220403012958069](assert/b3f05786c8b69cc61fe63351345024a1_MD5.png)
...
![image-20220403013733314](assert/73143cc7a6a5a7069683878e6de55f24_MD5.png)

点击开始配置会提示身份认证相关，扫完码后将会到如下配置

![image-20220403013828824](assert/e180d7832e9a2c397383d3294d67f9b5_MD5.png)
...
![image-20220403014345645](assert/4bad1856ff576b8458f4a7d441bb6094_MD5.png)
