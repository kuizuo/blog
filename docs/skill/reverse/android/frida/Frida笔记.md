...
```sh
adb push C:\Users\Ray\Desktop\frida-server-15.1.14-android-arm64 /data/local/tmp/fsarm64
...
let Utils = Java.use('com.Ray.app.Utils')
```
...
```javascript
const Utils = Java.use('com.Ray.app.Utils')
...
var Person = Java.use('com.Ray.app.Person')
var person = Person.$new('Ray', 20)
arrayList.add('Ray')
...
```
adb push C:\Users\Ray\Desktop\frida-inject-15.1.14-android-arm64 /data/local/tmp/fiarm64
