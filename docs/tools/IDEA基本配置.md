...
![image-20220106052026798](assert/6df055419a99ce8a11f10f5c7ea93b1d_MD5.png)

### 修改 Maven 依赖仓库位置

一般 Maven 所下载的依赖都会存储在`C:\User\{user}\.m2\repository` ，通过下图位置可以将其移动到其他地方。

![image-20220106052100190](assert/0f621a0c697cb4205afd42d8d42e0665_MD5.png)

## 配置导入与导出

具体操作如下图，根据自己需要进行导入与导出

![image-20220616135757525](assert/2526bc25a319833dbc253823c4c08fd2_MD5.png)

导出

![image-20220616135810570](assert/b01d908c768f40ce7e7d628d2fcd8b0e_MD5.png)

导入

![image-20220616135847464](assert/b7c6dcf13a65a6faef8009086878a76e_MD5.png)
