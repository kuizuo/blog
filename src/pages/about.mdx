...
# 👋 你好! 我是Sunny, 我想说
☀️ 世俗的枷锁,束缚不了自由的灵魂;我们最终都会死去,车房子亲情爱情最终都会失去;世人笑我太疯癫,我笑他们看不穿;
...
Sunny，希望自己可以有一个阳光的性格,做阳光的事情。也是本人使用此名所想表达的意思。


### 🛠 技术栈
#### 编程语言
📚 目前工作在华为,工作经验:全栈开发, 使用过Python>TS(JS)>Rust>Go>PHP
...
<a href="https://github.com/ydaydayup">
    <img
        src="https://metrics.lecoq.io/ydaydayup?template=classic&base.activity=0&base.community=0&base.repositories=0&base.metadata=0&isocalendar=1&base=header%2C%20activity%2C%20community%2C%20repositories%2C%20metadata&base.indepth=false&base.hireable=false&isocalendar=false&isocalendar.duration=full-year&config.timezone=Asia%2FShanghai"/>
</a>
...
<p>
    ...
    <a href="https://github.com/ydaydayup">Github</a>
</p>
...
<p>
    ...
    <a href="https://twitter.com/ydaydayup">Twitter</a>
</p>

<p>
    <Icon icon="ri:mail-open-line" width="20" heigth="20"/>{' '}
    <a href="mailto:hi@Sunny.cn">hi@Sunny.cn</a>
</p>
