...
function blogPluginEnhanced(context, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign(Object.assign({}, blogPluginInstance), { contentLoaded({ content, allContent, actions }) {
                return __awaiter(this, void 0, void 0, function* () {
                    // Create default plugin pages
                    yield blogPluginInstance.contentLoaded({ content, allContent, actions });
